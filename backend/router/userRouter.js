...
const {registerUser,loginUser, logOut,forgotPassword,resetPassword,createReview, getUserDetail, updatePassword, updateProfile, getAllUser, getUser, updateUser, deleteUser, getProductReviews, deleteReview, deleteAccount} = require('../controller/userController')
